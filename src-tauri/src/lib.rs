...
pub fn run() {
    tauri::Builder::default()
		...
		commands::textmate_tokenize_line_binary,
            ...
            commands::extension_platform_report_ws_connected,
            commands::extension_platform_report_host_ready,
            commands::extension_platform_report_ws_closed,
            commands::extension_platform_report_host_ready_timeout,
            commands::extension_platform_report_activation_failed,
            commands::extension_platform_report_host_exited,
            ...
            commands::wasm_get_tree_children,
            commands::wasm_get_tree_item,
            commands::wasm_on_tree_item_activated,
            commands::wasm_on_tree_visibility_changed,
